...
router.put("/books/return/:bookId", verifyLibrarian, libraryController.returnBook); // Only Librarian can allow returns

// Transaction routes
router.get(
  "/transactions",
  verifyAll,
  libraryController.fetchAllTransactions
); // Admin or Staff can view all transactions
router.get(
