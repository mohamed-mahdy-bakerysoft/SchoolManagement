  ...
  return (
    ...
    <div className="p-4 max-w-3xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <label htmlFor="bookId" className="block text-gray-700 font-bold mb-1">
            Book ID
          </label>
          <input
            id="bookId"
        ...
        <div>
          <label htmlFor="bookName" className="block text-gray-700 font-bold mb-1">
            Book Name
          </label>
          <input
            id="bookName"
        ...
        <div>
          <label htmlFor="author" className="block text-gray-700 font-bold mb-1">
            Author
          </label>
          <input
            id="author"
