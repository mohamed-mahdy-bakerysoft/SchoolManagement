...
export const deleteStudent = async (studentId, token) => {
  try {
    const response = await apiInstance.delete(
      `/api/students/${studentId}`, // API endpoint to delete a student by Student ID
      {
        headers: {
          Authorization: `Bearer ${token}`, // Pass token in headers
        },
...
export const fetchStudentById = async (studentId, token) => {
  try {
    const response = await apiInstance.get(
      `/api/students/${studentId}`, // API endpoint to fetch a student by Student ID
      {
        headers: {
          Authorization: `Bearer ${token}`, // Pass token in headers
        },
